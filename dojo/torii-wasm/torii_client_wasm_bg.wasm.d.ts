...
export function wasm_bindgen__convert__closures__invoke1_mut__h29b802f7858003a5(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h03a63bf543ff1182(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__hc55dc97de08ba12d(a: number, b: number, c: number, d: number): void;
